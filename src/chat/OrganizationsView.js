		...
		<Fragment>
			...
			<ul className="list-group mb-5" style={{ listStyle: 'none' }}>
				{organization.map((org) => (
					<Fragment>
						{(org.acronym.includes('CONNA') || org.acronym.includes('ISNA')) && (
							<li key={org.id} className="card a-list-item mb-2  px-3 bg-secondary">
								<blockquote className="blockquote text-center highlight text-break">
										...
										<ul className="list-group list-group-flush" style={{ listStyle: 'none' }}>
											<li className="mb-2">
												<span>
													...
													<span className="font-weight-bold">Encargado/a: </span>
													{org.officer_name}
												</span>
											</li>
											...
											<li className="mb-2 text-center">
												<BsFillCaretRightFill /> <span className="font-weight-bold">Redes</span>
												<div className="row">
													...
													<div className="col-md-4">
														{org.youtube_url && !org.youtube_url.includes(',') ? (
															<a
																...
																rel="noopener noreferrer"
															>
																<FaYoutube size="1.5rem" className="text-danger" />
															</a>
														) : (
									...
									<footer className="blockquote-footer">
										<span className="Source Title">
											<span className="font-weight-bold">correo:</span> {org.officer_email}
										</span>
									</footer>
								</blockquote>
							</li>
